...
public class UserController {
	...
	@GetMapping
	public String index(@AuthenticationPrincipal UserDetailsImpl userDetailsImpl, Model model) {//現在ログイン中のユーザー情報を取得
		//UserDetailsImplオブジェクトからユーザーのIDを取得し、それをリポジトリのgetReferenceById()メソッドに渡す
