...
public class AuthController {
	...
	public String signup(@ModelAttribute @Validated SignupForm signupForm, BindingResult bindingResult,
			RedirectAttributes redirectAttributes, HttpServletRequest httpServletRequest) {// 引数でHttpServletRequestオブジェクトを受け取り、動的にURLを取得
	...
	public String verify(@RequestParam(name = "token") String token, Model model) {//URLのパラメータの値をその引数にバインド
