...
public class AuthController {
	...
	public String signup(@ModelAttribute @Validated SignupForm signupForm, BindingResult bindingResult,
		...
		String requestUrl = new String(httpServletRequest.getRequestURL());//動的にURLを取得
		signupEventPublisher.publishSignupEvent(createdUser, requestUrl);//イベントの発行
